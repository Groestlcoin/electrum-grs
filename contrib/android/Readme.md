...
See the [`builds` workflow](https://github.com/groestlcoin/electrum-grs/actions/workflows/builds.yml).
Open the run of interest and download the `electrum-grs-android-*` artifact.
