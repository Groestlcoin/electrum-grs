...
from electrum_grs.util import is_subpath, ChoiceItem, multisig_type, UserCancelled, standardize_path
...
from electrum_grs.wizard import NewWalletWizard, KeystoreWizard, WizardViewState

from electrum_grs.gui.common_qt.util import ignore_if_destroyed
...
if TYPE_CHECKING:
    ...
    from electrum_grs.plugin import Plugins, DeviceInfo
...
class WCWalletType(WalletWizardComponent):
    def __init__(self, parent, wizard):
        ...
        wallet_kinds = [
            ...
            ChoiceItem(key='imported', label=_('Import Groestlcoin addresses or private keys')),
        ]
