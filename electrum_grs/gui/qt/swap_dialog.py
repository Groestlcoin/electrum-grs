...
from electrum_grs.util import NotEnoughFunds, NoDynamicFeeEstimates, UserCancelled, trigger_callback
from electrum_grs.bitcoin import DummyAddress
from electrum_grs.transaction import PartialTxOutput, PartialTransaction, PartialTxInput
...
if TYPE_CHECKING:
    ...
    from electrum_grs.submarine_swaps import SwapServerTransport, SwapOffer
